...
public enum LegalAvatarType {
    ...
    public static LegalAvatarType detectImageType(InputStream inputStream) throws IOException {
        if (inputStream == null) {
        ...
        return Arrays.stream(values())
                ...
                .findFirst()
                .orElseThrow(() -> new BusinessException(ResultCode.FILE_TYPE_NOT_SUPPORT));
    }
